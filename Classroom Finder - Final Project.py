...
ynErrorMessage="Sorry for the Inconvinience! Try again but answer with yes or no next time! "
...
def main():
    ...
    print("Hello Mate! Welcome to the ExploreMate Chatbot!  \nI will help you to find your Classroom and Faculty Location")
    print("- "*51)
    #Creates empty list for class item numbers
    itemNum=[]
    #Asks user if they remember their class item number
    answer=input("Let me know what you would like me to find ?\nFor Me Please Press \nY for Classroom Locator \nOR \nN for Faculty Locator\n")
    print()
    #calls the classGetter function with the user's input as a parameter in the function
    itemNum.append(classGetter(answer))
    print("\nI have Located Your Classroom!")
    print("- -"*34)
    ...
    while condition1==0:
        ...
        answer2=input("Till Then do you like me to find any other classroom for You? (y/n) ")
        print()
    ...
    while answer2.lower()=="y" or answer2.lower()=="yes":
        ...
        while condition4==0:
            answer3=input("Do you remember your Classroom number? (y/n) ")
            print()
        ...
        while condition2==0:
            ...
            answer2=input("Do you like me to find any other classroom for You? (y/n) ")
            print()
            if answer2.lower()=="y" or answer2.lower()=="yes" or answer2.lower()=="n" or answer2.lower()=="no":
                condition2=1
            else:
    ...
    print("\nAll done Mate! Your class location has been displayed. Thanks for using Exploremate! :)")
    ...
    for i in range(len(className)):
        ...
        for j in range(1):
            if summary[j].roomN=="ONL":
                ...
                print(">",summary[j].classN,"is not located at NMIMS College. ")
            else:
...
def classGetter(answer):
    ...
    if answer.lower()=="y"or answer.lower()=="yes":
        itemNum=input("What is your ClassRoom number? ")
        print()
    ...
    #If answer equals n/no, ask the user for the teacher they are enrolled with
        ...
        teacher=input("Please provide me your Teacher's Name so that I can begin my search \n ")
        ...
        while condition3==0:
            ...
            if teacherNums==[]:
                teacher=input("Looks like that Professor doesn't exist in our data, \n[ NOTE:Currently I'm only available with professor at NMIMS College Faculty Area 601 :( ] \n ")
                teacher=teacher.lower()
                print()
            else:
                condition3=1
        ...
        itemNum=input("Can you enter the code for your classroom:- ")
...
# Function to display class location image
def displayClassLocation(buildingName, className, roomNumber):
    # If the class is online or arranged, notify the user and return
    if roomNumber in ["ONL", "ARR"]:
        print(className + " - There is no location for this classroom" if roomNumber == "ONL" else
              className + " - The location of this classroom will be given by your instructor")
        return

    # Construct the file name ("___.png")
    buildingName = "images/" + buildingName + ".png"

    # Open the image file
    img = Image.open(buildingName)

    # Display the image
    img.show()


# Modify the main function to remove references to the graphics module
